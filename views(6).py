...
class MainView(LoginRequiredMixin, View):
    def get(self, request):
        br = Breed.objects.count()
        ct = Cat.objects.all()

        cty = {'breed_count': br, 'cat_list': ct}
        return render(request, 'cats/cat_list.html', cty)
...
class BreedView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        cty = {'breed_list': bd}
        return render(request, 'cats/breed_list.html', cty)
...
class BreedCreate(LoginRequiredMixin, View):
    ...
    def get(self, request):
        form = BreedForm()
        cty = {'form': form}
        return render(request, self.template, cty)
